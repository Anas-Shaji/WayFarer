...
$mail->Username = 'wayfarer11411@gmail.com';   // SMTP username 
$mail->Password = 'Mock@#$2078';   // SMTP password 
...
<p>Hai,</p>
<p>Your trip has been confirmed and all the process is Complete.. (Let us have some cheers for that)</p>
...
Explore from here --- >> <a href="http://localhost/WayFarer/index.php">WayFarer</a></div>
</center>
</body>
</html>'; 
