						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
									 ...
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Destinations</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									...
									<li><a href="manage-guide.php"><i class="fa fa-users" aria-hidden="true"></i>  <span>Manage Guide</span><div class="clearfix"></div></a></li>
									<li><a href="create-guide.php"><i class="fa fa-users" aria-hidden="true"></i>  <span>Add Guide</span><div class="clearfix"></div></a></li>
